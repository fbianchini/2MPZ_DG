...
cat_tmp = twompz[(twompz.ZSPEC >= zmin) & (twompz.ZSPEC < zmax)]
...
clkg_th = GetCrossSpectrum(cosmo_nl, z, nz, [zmin,zmax], b=bias, alpha=1., lmax=500, sigma_zph=0.)
clgg_th = GetAutoSpectrum(cosmo_nl, z, nz,  [zmin,zmax], b=bias, alpha=1., lmax=500, sigma_zph=0.)
...
# est = cs.Master(np.ones_like(mask), lmin=lmin, lmax=lmax, delta_ell=delta_ell, MASTER=0, pixwin=False)
est = cs.Master(mask, lmin=lmin, lmax=lmax, delta_ell=delta_ell, MASTER=0, pixwin=False)
# est = cs.Master(hp.smoothing(mask, fwhm=np.radians(30./60.)), lmin=lmin, lmax=lmax, delta_ell=delta_ell, MASTER=1, pixwin=False)
...
# fname_gg = 'clgg_sims_dl'+str(delta_ell)+'_lmin_'+str(lmin)+'_lmax'+str(lmax)+'_KS_min_'+str(K_S_min)+'_KS_max_'+str(K_S_max)+'_nside'+str(nside)+'_zmin_'+str(zmin)+'_zmax'+str(zmax)+'_nsims'+str(nsims)+'_spec.pkl.gz'
# fname_kg = 'clkg_sims_dl'+str(delta_ell)+'_lmin_'+str(lmin)+'_lmax'+str(lmax)+'_KS_min_'+str(K_S_min)+'_KS_max_'+str(K_S_max)+'_nside'+str(nside)+'_zmin_'+str(zmin)+'_zmax'+str(zmax)+'_nsims'+str(nsims)+'_spec.pkl.gz'
...
fname_gg = 'clgg_sims_dl'+str(delta_ell)+'_lmin_'+str(lmin)+'_lmax'+str(lmax)+'_KS_min_'+str(K_S_min)+'_KS_max_'+str(K_S_max)+'_nside'+str(nside)+'_zmin_'+str(zmin)+'_zmax'+str(zmax)+'_nsims'+str(nsims)+'_fsky.pkl.gz'
fname_kg = 'clkg_sims_dl'+str(delta_ell)+'_lmin_'+str(lmin)+'_lmax'+str(lmax)+'_KS_min_'+str(K_S_min)+'_KS_max_'+str(K_S_max)+'_nside'+str(nside)+'_zmin_'+str(zmin)+'_zmax'+str(zmax)+'_nsims'+str(nsims)+'_fsky.pkl.gz'
