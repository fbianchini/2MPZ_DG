...
def main(args):
	...
	cat_tmp2 = twompz2[(twompz2.ZPHOTO >= args.zmin) & (twompz2.ZPHOTO < args.zmax)]
	...
	# XC estimator ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	est_mask = cs.Master(mask, lmin=lmin, lmax=lmax, delta_ell=delta_ell, MASTER=0, pixwin=True)
	...
	clGS_2mpz, err_gg_2mpz = est_mask.get_spectra(delta_sum2, analytic_errors=True)
	...
	ax.plot(clgg_nl, color='darkgrey', ls='--', label=r'NL $b=1$ $\sigma_z=0.015$')
